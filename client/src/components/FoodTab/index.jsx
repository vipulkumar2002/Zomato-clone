...
const MobileViews = () => {
  ...
  return (
    <>
      <div className="lg:hidden pr-5 pl-5 flex bg-white shadow-lg fixed bottom-0 z-10 w-full items-center justify-between md:justify-evenly text-gray-500 border">
        {alltypes.map((item) => (
